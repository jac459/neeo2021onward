...
#  Its main purpose is to load the actual backend-code and run it. 
   ...
   # beta MyURL="https://raw.githubusercontent.com/Ton-o/neeo2021onward/Beta-2021-01%232/Meta%20running%20in%20Brain/installmeta-Backend.sh"
   MyURL='https://raw.githubusercontent.com/Ton-o/neeo2021onward/Beta-2021-01%233/Meta%20running%20in%20Brain/installmeta-Backend.sh'
