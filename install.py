...
MyPackages =  [
              ...
              {"name":"nodered","type":PackageTypeAPT,"reqvers": "","status":NotInst,"Inst_Vers":"", "CMDLine": "node-red list","phaserequired":1,"loc": "", "PKGParm":"","PKGParm2":"","PackageUSER":"","mydep":{"nodejs","npm"},"startcmd":{"pm2 start /usr/bin/node-red --node-args='--max-old-space-size=128' -- -v"}},
              {"name":"mosquitto","type":PackageTypeAPT,"reqvers": "","status":NotInst,"Inst_Vers":"", "CMDLine": "node-red list","phaserequired":1,"loc": "", "PKGParm":"","PKGParm2":"","PackageUSER":"","mydep":{},"startcmd":{"systemctl stop mosquitto","systemctl disable mosquitto","sleep 10s","pm2 start mosquitto -- -v  "}},
              {"name":"meta","type":PackageTypeNPM,"reqvers": "","status":NotInst,"Inst_Vers":"", "CMDLine": "node-red list","phaserequired":1,"loc": ".meta", "PKGParm":"npm install ","PKGParm2":"jac459/metadriver","PackageUSER":"","mydep":{"npm","git","pm2"},"startcmd":{"pm2 start .meta/node_modules/@jac459/metadriver/meta.js"}}
              ]
